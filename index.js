...
app.get('/', function(req, res) {
	...
	io.on('connection', function(socket) {
		...
		socket.on('player connect', function() {
			...
			// in your current game we need to tell u about the other players
		...
		socket.on('health',  function(data) {
			...
			//only Change the healeyh once, we can do this by checking the originating player
			if(data.from == currentPlayer.name){
				...
				var response = {
					name: (!data.isEnemy) ? clients[indexDamaged].name : enemies[indexDamaged].name, // This is Like If else
